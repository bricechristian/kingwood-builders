						...
						{projects.map((item, index) => {
							...
							return (
								<SwiperSlide key={item._id} className="md:overflow-hidden">
									...
									<div className="grid grid-cols-11 md:grid-cols-10 md:min-h-[950px]">
										...
										<div className="col-span-8 md:col-span-6 md:mt-0 md:absolute md:right-0 md:bottom-0 md:w-full md:h-full md:max-w-[100vw]">
											<div className="after:block after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-black after:opacity-20 md:absolute md:bottom-0 md:right-0 md:after:opacity-100 md:after:bg-transparent md:after:bg-gradient-to-b md:after:h-2/3 md:from-neutral md_min:relative">
												<Image
													{...imageProps}
