import './404.astro.2f44899a.mjs';
import '@sanity/client';
import '../astro.ae63679d.mjs';
import 'cookie';
import 'kleur/colors';
import 'slash';
...
const index = {
  ...
  </style></head><body><div id="sanity"></div><script type="module" src="/static/sanity-4396448b.js"></script><noscript><div class="sanity-app-no-js__root"><div class="sanity-app-no-js__content"><style type="text/css">
