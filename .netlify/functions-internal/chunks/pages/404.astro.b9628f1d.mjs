...
import { c as createAstro, a as createComponent, r as renderTemplate, d as defineScriptVars, b as addAttribute, s as spreadAttributes, u as unescapeHTML, e as renderComponent, m as maybeRenderHead, f as renderSlot, g as renderHead } from '../astro.2cf47c56.mjs';
/* empty css                         */
...
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.url.pathname.includes("/admin")) {
    return Astro2.redirect("https://kingwoodbuilders.sanity.studio/");
  }
